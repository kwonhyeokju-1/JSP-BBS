    ...
    <nav class ="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="main9.jsp">메인</a></li>
                <li><a href="bbs9.jsp">게시판</a></li>
            </ul>
            <%
 	...
 	<div class="container">
 		<div class="jumbotron">
 			<div class="container">
 				<h1>무소속/송영헌</h1>
 				<p>달서구 제 2선거구. 소통 게시판에 오신 걸 환영합니다. </p>
 				<p><a class="btn btn-primary btn-pull" href="https://www.facebook.com/syh3975" role="button">의원님 자세히 알아보기</a></p>
