...
%>
    <nav class ="navbar navbar-default">
        <div class="navbar-header"> <!-- 홈페이지의 로고 -->
            ...
            <a class ="navbar-brand" href="main2.jsp">달서구 국회의원 게시판</a>
        </div>
 	...
 	<div class="container">
 		<div class="jumbotron">
 			<div class="container">
 				...
 				<p><a class="btn btn-primary btn-pull" href="https://www.facebook.com/hotso70" role="button">의원님 자세히 알아보기</a></p>
